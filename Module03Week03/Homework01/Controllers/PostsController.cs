...
namespace Homework01.Controllers
{
    ...
    public class PostsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Text,Language,CategoryId")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Text,Language,CategoryId")] Post post)
        {
            if (ModelState.IsValid)
            {
